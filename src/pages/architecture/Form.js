...
function Form({page, result, setResult, errs, errsTechSkills, setErrsTechSkills, covidErrs, setCovidErrs, errRedberianInsights, setErrRedberianInsights}) {
    //console.log(page)
    return (
      <div className="form">
        { page === 2 && <PersonalInfoForm result={result} setResult={setResult} errs={errs} />}
        { page === 3 && <TechnicalSkillsetForm result={result} setResult={setResult} errsTechSkills={errsTechSkills} setErrsTechSkills={setErrsTechSkills}/>}
